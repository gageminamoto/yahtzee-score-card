    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center p-4 z-50 animate-fadeIn">
      ...
      >
        ...
        <div className="mb-8">
          ...
          {category.fixedScore && (
            <p className="font-sans text-ui text-white opacity-70 mt-2">
              Enter {category.fixedScore} or 0
            </p>
          )}
        </div>
        ...
        {/* Score Display */}
        <div className="mb-8">
          <div className="bg-black bg-opacity-20 border-4 border-black p-6 text-center">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[7, 8, 9, 4, 5, 6, 1, 2, 3].map(num => (
            <button
              ...
              className="bg-black bg-opacity-20 border-4 border-black text-white font-serif text-subtitle py-4 hover:bg-opacity-40 active:scale-95 transition-all"
            >
              {num}
            </button>
          ))}
          <button
            ...
            className="bg-black bg-opacity-20 border-4 border-black text-white font-sans text-body-lg py-4 hover:bg-opacity-40 active:scale-95 transition-all"
          >
            X
          </button>
          <button
